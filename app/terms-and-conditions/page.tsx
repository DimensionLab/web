...
export default function Index() {
  return (
    <div className="text-white">
      <section
        className="title-hero-bg widget-cover-bg"
      ...
      >
        <div className="container">
          <div className="page-title text-center">
            <p className="m-10">
              <Link href="/">
                <span className="white-color hover:text-gray-300 duration-300">← Back</span>
              </Link>
            </p>
          </div>
        </div>
      ...
      <section>
        <div className="container dark-color prose prose-invert text-white">
          <div className="row">
            <div className="col-md-12 terms">
              <h1 className="font-700 dark-color">Terms &amp; Conditions</h1>
              <p>Updated at 2021-09-01</p>

              <h3>General Terms</h3>
              <p>
                By accessing and placing an order with DimensionLab, you confirm
                ...
                communication between you and DimensionLab.
              </p>
              <p>
                Under no circumstances shall DimensionLab team be liable for any
                ...
                site, even if DimensionLab team or an authorized representative
              ...
              <p>
                DimensionLab will not be responsible for any outcome that may
              ...
              <h3>License</h3>
              <p>
                DimensionLab grants you a revocable, non-exclusive,
              ...
              <p>
                ...
                DimensionLab (referred to in these Terms &amp; Conditions as
                &quot;DimensionLab&quot;, &quot;us&quot;, &quot;we&quot; or
                &quot;our&quot;), the provider of the DimensionLab website and
                the services accessible from the DimensionLab website (which are
                collectively referred to in these Terms &amp; Conditions as the
                &quot;DimensionLab Service&quot;).
              </p>
              <p>
                You are agreeing to be bound by these Terms &amp; Conditions. If
                you do not agree to these Terms &amp; Conditions, please do not
                use the DimensionLab Service. In these Terms &amp; Conditions,
              ...
              <ul>
                ...
                <li>
                  ...
                  “our,” it refers to DimensionLab s.r.o., Lomnická 809/2, 040
                  01 Košice, Slovakia that is responsible for your information
                  under this Terms &amp; Conditions.
                </li>
                <li>
                  Country: where DimensionLab or the owners/founders of
                  DimensionLab are based, in this case is SK
                </li>
                <li>
                  Device:&nbsp;any internet connected device such as a phone,
                  tablet, computer or any other device that can be used to visit
                  DimensionLab and use the services.
                </li>
                <li>
                  Service: refers to the service provided by DimensionLab as
                ...
                <li>
                  Website: DimensionLab&apos;s site, which can be accessed via
                  this URL: https://dimensionlab.org
                </li>
                <li>
                  You: a person or entity that is registered with DimensionLab
                  to use the Services.
                </li>
              </ul>
              ...
              <ul>
                ...
                <li>
                  ...
                  notice of copyright or trademark) of DimensionLab or its
              ...
              <p>
                Thanks for shopping at DimensionLab. We appreciate the fact that
              ...
              <p>
                ...
                that apply to transactions at DimensionLab. We&apos;ll be as
                brief as our attorneys will allow. The main thing to remember is
                that by placing an order or making a purchase at DimensionLab,
                you agree to the terms along with
                DimensionLab&apos;s&nbsp;Privacy Policy.
              </p>
              <p>
              ...
              <p>
                ...
                DimensionLab with respect to the website shall remain the sole
                and exclusive property of DimensionLab.
              </p>
              <p>
                DimensionLab shall be free to use, copy, modify, publish, or
              ...
              <p>
                ...
                you with complete transparency into what is being set when you
              ...
              <p>
                ...
                controlled by DimensionLab. We are not responsible for the
              ...
              <h3>Cookies</h3>
              <p>
                DimensionLab uses &quot;Cookies&quot; to identify the areas of
              ...
              <p>
                You acknowledge and agree that DimensionLab may stop
                (permanently or temporarily) providing the Service (or any
                features within the Service) to you or to users generally at
                DimensionLab&apos;s sole discretion, without prior notice to
                you. You may stop using the Service at any time. You do not need
                to specifically inform DimensionLab when you stop using the
                Service. You acknowledge and agree that if DimensionLab disables
              ...
              <p>
                DimensionLab reserves the right to modify, suspend or
              ...
              <p>
                DimensionLab may from time to time provide enhancements or
              ...
              <p>
                ...
                functionalities of the website. You agree that DimensionLab has
              ...
              <p>
                You acknowledge and agree that DimensionLab shall not be
                ...
                thereof. DimensionLab does not assume and shall not have any
              ...
              <p>
                DimensionLab may, in its sole discretion, at any time and for
              ...
              <p>
                ...
                from DimensionLab, in the event that you fail to comply with any
              ...
              <p>
                ...
                DimensionLab's rights or remedies at law or in equity in case of
              ...
              <p>
                You agree to indemnify and hold DimensionLab and its parents,
              ...
              <p>
                ...
                maximum extent permitted under applicable law, DimensionLab, on
                ...
                practice. Without limitation to the foregoing, DimensionLab
              ...
              <p>
                Without limiting the foregoing, neither DimensionLab nor any
                DimensionLab's provider makes any representation or warranty of
                ...
                content, or e-mails sent from or on behalf of DimensionLab are
              ...
              <p>
                ...
                liability of DimensionLab and any of its suppliers under any
              ...
              <p>
                ...
                shall DimensionLab or its suppliers be liable for any special,
                ...
                Agreement), even if DimensionLab or any supplier has been
              ...
              <p>
                ...
                legal notices published by DimensionLab on the Services, shall
                constitute the entire agreement between you and DimensionLab
                ...
                term or any other term, and DimensionLab's failure to assert any
                right or provision under this Agreement shall not constitute a
                waiver of such right or provision. YOU AND DimensionLab AGREE
              ...
              <p>
                DimensionLab reserves the right, at its sole discretion, to
              ...
              <p>
                ...
                DimensionLab regarding your use of the website and supersedes
                all prior and contemporaneous written or oral agreements between
                you and DimensionLab.
              </p>
              <p>
                You may be subject to additional terms and conditions that apply
                when you use or purchase other DimensionLab's services, which
                DimensionLab will provide to you at the time of such use or
                purchase.
              </p>
              ...
              <p>
                ...
                arrangement thereof), are owned by DimensionLab, its licensors
                or other providers of such material and are protected by SK and
                ...
                prior written permission of DimensionLab, unless and except as
                is expressly provided in these Terms &amp; Conditions. Any
              ...
              <p>
                ...
                REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR OR DimensionLab's
                INTELLECTUAL PROPERTY RIGHTS. The term “dispute” means any
                dispute, action, or other controversy between you and
                DimensionLab concerning the Services or this agreement, whether
              ...
              <p>
                In the event of a dispute, you or DimensionLab must give the
                ...
                <a
                  ...
                  data-cfemail="dfb7bab3b3b09fbbb6b2bab1acb6b0b1b3bebdf1b0adb8f1"
                >
                  [email&nbsp;protected]
                </a>{" "}
                DimensionLab will send any Notice of Dispute to you by mail to
                your address if we have it, or otherwise to your email address.
                You and DimensionLab will attempt to resolve any dispute through
                informal negotiation within sixty (60) days from the date the
                Notice of Dispute is sent. After sixty (60) days, you or
                DimensionLab may commence arbitration.
              </p>

              <h3>Binding Arbitration</h3>
              <p>
                If you and DimensionLab don’t resolve any dispute by informal
              ...
              <p>
                ...
                property of DimensionLab without any compensation or credit to
                you whatsoever. DimensionLab and its affiliates shall have no
              ...
              <h3>Promotions</h3>
              <p>
                DimensionLab may, from time to time, include contests,
              ...
              <p>
                ...
                DimensionLab. DimensionLab will be entitled to injunctive or
                other equitable relief (without the obligations of posting any
                bond or surety) in the event of any breach or anticipatory
                breach by you. DimensionLab operates and controls the
                DimensionLab Service from its offices in SK. The Service is not
                ...
                choose to access the DimensionLab Service from other locations
                ...
                incorporate the DimensionLab Privacy Policy) contains the entire
                understanding, and supersedes all prior understandings, between
                you and DimensionLab concerning its subject matter, and cannot
                be changed or modified by you. The section headings used in this
              ...
              <h3>Disclaimer</h3>
              <p>
                DimensionLab is not responsible for any content, code or any
                other imprecision.
              </p>
              <p>DimensionLab does not provide warranties or guarantees.</p>
              <p>
                In no event shall DimensionLab be liable for any special,
              ...
              <p>
                The DimensionLab Service and its contents are provided "as is"
                and "as available" without any warranty or representations of
                any kind, whether express or implied. DimensionLab is a
                distributor and not a publisher of the content supplied by third
                parties; as such, DimensionLab exercises no editorial control
                ...
                via the DimensionLab Service. Without limiting the foregoing,
                DimensionLab specifically disclaims all warranties and
                representations in any content transmitted on or in connection
                with the DimensionLab Service or on sites that may appear as
                links on the DimensionLab Service, or in the products provided
                as a part of, or otherwise in connection with, the DimensionLab
                Service, including without limitation any warranties of
                merchantability, fitness for a particular purpose or
                non-infringement of third party rights. No oral advice or
                written information given by DimensionLab or any of its
                ...
                foregoing, DimensionLab does not warrant that the DimensionLab
              ...
              <ul>
                ...
                <li>
                  Via this Address: Lomnická 809/2, 040 01 Košice, Slovakia
                </li>
              </ul>
            </div>
          </div>
      ...
      <a
        href="#"
        id="back-to-top"
        className="fixed bottom-8 right-8 bg-white/10 hover:bg-white/20 text-white rounded-full p-3 backdrop-blur-sm shadow-lg transition-all duration-300 hover:scale-110"
        title="Back to top"
      >
        <svg
