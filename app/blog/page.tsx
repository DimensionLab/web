...
export default function BlogRootPage() {
  ...
  return (
    <section className="flex flex-col w-full h-full gap-y-12 my-8">
      <h1 className="font-bold text-2xl sm:text-5xl mx-auto">Blog</h1>
      <h3 className="text-[#B4B6C3] font-normal text-xl lg:line-clamp-2 mx-auto text-center">
        Articles that explore the application of AI in engineering and science, by DimensionLab team
      </h3>
      ...
      {(total >= (currPage - 1) * STORIES_PER_PAGE) && <section className="flex justify-center">
        <div className="flex flex-row items-center justify-center w-full gap-x-10 max-w-2xl mt-10">
          <button
