        ...
        <div className="container dark-color prose prose-invert text-white">
          <div className="row">
            <div className="col-md-12 terms">
              <h1 className="font-700">Privacy Policy</h1>
              <p>Updated at 2021-09-01</p>

              <p>
                {" "}
                DimensionLab (“we,” “our,” or “us”) is committed to protecting
                your privacy. This Privacy Policy explains how your personal
                information is collected, used, and disclosed by DimensionLab.
              </p>
              <p>
                This Privacy Policy applies to our website, and its associated
                subdomains (collectively, our “Service”) alongside our
                application, DimensionLab. By accessing or using our Service,
              ...
              <ul>
                ...
                <li>
                  ...
                  DimensionLab are based, in this case is Slovakia
                </li>
                <li>
                  Customer:&nbsp;refers to the company, organization or person
                  that signs up to use the DimensionLab Service to manage the
                ...
                <li>
                  ...
                  by DimensionLab or are under contract to perform a service on
                ...
                <li>
                  Website: DimensionLab's site, which can be accessed via this
              ...
              <p>
                ...
                or navigate the&nbsp;platform. This information does not reveal
                ...
                location, information about who and when you use our&nbsp;and
                other technical information. This information is primarily
                needed to maintain the security and operation of
                our&nbsp;platform, and for our internal analytics and reporting
                purposes.
              </p>
              <h3>Personnel</h3>
              <p>
                If you are a DimensionLab worker or applicant, we collect
              ...
              <p>
                ...
                substantially all of the assets of DimensionLab or any of its
                Corporate Affiliates (as defined herein), or that portion of
                DimensionLab or any of its Corporate Affiliates to which the
              ...
              <p>
                ...
                under common control with DimensionLab, whether by ownership or
              ...
              <h3>Governing Law</h3>
              <p>
                This Privacy Policy is governed by the laws of Slovakia without
              ...
              <p>
                The laws of Slovakia, excluding its conflicts of law rules,
              ...
              <p>
                By using DimensionLab or contacting us directly, you signify
              ...
              <p>
                ...
                by DimensionLab. We are not responsible for the content,
              ...
              <h3>Cookies</h3>
              <p>
                DimensionLab uses "Cookies" to identify the areas of our website
              ...
              <p>
                ...
                facts it's simply the right thing to do. At DimensionLab we
              ...
              <p>
                ...
                subject rights requirements of GDPR. DimensionLab processes or
              ...
              <p>
                ...
                to your data and your customers data. Our customer&nbsp;support
                team is here for you to answer any questions you might have
