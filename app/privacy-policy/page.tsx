    ...
    <div className="container dark-color">
      <div className="row">
        <div className="col-md-12 terms">
          ...
          <p> DimensionLab (“we,” “our,” or “us”) is committed to protecting your privacy. This Privacy Policy
            explains how your personal information is collected, used, and disclosed by DimensionLab.</p>
          <p>This Privacy Policy applies to our website, and its associated subdomains (collectively, our “Service”)
            alongside our application, DimensionLab. By accessing or using our Service, you signify that you have
          ...
          <p>To help explain things as clearly as possible in this Privacy Policy, every time any of these terms are
            ...
            <li>Company: when this policy mentions “Company,” “we,” “us,” or “our,” it refers to DimensionLab s.r.o.,
              Lomnická 809/2, 040 01 Košice, Slovakia that is responsible for your information under this Privacy
              Policy.</li>
            <li>Country: where DimensionLab or the owners/founders of DimensionLab are based, in this case is Slovakia
            </li>
            <li>Customer:&nbsp;refers to the company, organization or person that signs up to use the DimensionLab Service
            ...
            <li>Personnel:&nbsp;refers to those individuals who are employed by DimensionLab or are under contract to
          ...
          <p>There is some information like your Internet Protocol (IP) address and/or browser and device
            ...
            your device for fraud prevention and diagnostic purposes.</p>
          <p>We automatically collect certain information when you visit, use or navigate the&nbsp;platform. This
            ...
            security and operation of our&nbsp;platform, and for our internal analytics and reporting purposes.</p>
          <h3>Personnel</h3>
          <p>If you are a DimensionLab worker or applicant, we collect information you voluntarily provide to us. We
            use the information collected for Human Resources purposes in order to administer benefits to workers and
            screen applicants.</p>
          <p>You may contact us in order to (1) update or correct your information, (2) change your preferences with
            ...
            information we have relating to you. Such updates, corrections, changes and deletions will have no effect
            on other information that we maintain, or information that we have provided to third parties in accordance
          ...
          <p>We reserve the right to transfer information to a third party in the event of a sale, merger or other
            transfer of all or substantially all of the assets of DimensionLab or any of its Corporate Affiliates (as
            defined herein), or that portion of DimensionLab or any of its Corporate Affiliates to which the Service
          ...
          <p>We may disclose information (including personal information) about you to our Corporate Affiliates. For
            ...
            indirectly controls, is controlled by or is under common control with DimensionLab, whether by ownership
          ...
          <h3>Governing Law</h3>
          <p>This Privacy Policy is governed by the laws of Slovakia without regard to its conflict of laws provision.
          ...
          <p>The laws of Slovakia, excluding its conflicts of law rules, shall govern this Agreement and your use of
            the website. Your use of the website may also be subject to other local, state, national, or international
            laws.</p>
          <p>By using DimensionLab or contacting us directly, you signify your acceptance of this Privacy Policy. If
          ...
          <p>This Privacy Policy applies only to the Services. The Services may contain links to other websites not
            operated or controlled by DimensionLab. We are not responsible for the content, accuracy or opinions
          ...
          <ul className="ml-40 mb-20">
            <li>Cookies
              ...
              <p>We use Cookies to enhance the performance and functionality of our $platform but are non-essential to
                ...
                you would be required to enter your login details every time you visit the $platform as we would not
          ...
          <p>GDPR adds some new requirements regarding how companies should protect individuals' personal data that
            ...
            greater fines for breach. Beyond these facts it's simply the right thing to do. At DimensionLab we
          ...
          <p>We are committed to helping our customers meet the&nbsp;data subject rights requirements of GDPR. DimensionLab
        ...
        <div className="row">
          <div className="col-sm-6 col-md-4">
            <div className="widget widget-text">
              <div className="logo logo-footer"><Link href="/"> <img className="py-4" src="/assets/branding/dl-title-intro.svg" alt="DimensionLab logo" /></Link> </div>
            </div>
          </div>
